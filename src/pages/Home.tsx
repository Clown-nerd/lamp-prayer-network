      ...
      <section className="py-16 lg:py-24 bg-gradient-to-b from-background to-muted/30">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            ...
            Living Altar Ministry of Prayer for Nations is an interdenominational Christian Organization committed to advancing the kingdom of God by awakening and equipping the Church in the ministry of prayer and intercession
          </p>
        </div>
      </section>
